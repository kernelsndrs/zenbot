...
module.exports = function container (get, set, clear) {
  ...
  return function (s) {
    ...
    function createTextUI() {
      ...
      s.error_log = s.grid.set(0, 0, 2, 12, blessed.log, {
        label: 'Errors',
        style: {
          focus: {
            border: {
      ...
      s.info_log = s.grid.set(2, 0, 3, 12, blessed.log, {
        label: 'Info',
        style: {
          focus: {
            border: {
      ...
      s.recent_periods = s.grid.set(5, 0, 3, 12, blessed.log, {
      ...
      s.current_data = s.grid.set(8, 0, 2, 12, blessed.log, {
        label: 'Current Data',
        style: {
          focus: {
            border: {
